...
export default function Staff_Cards(props) {
    ...
    return (
        <a href={props.action}>
            <div className="rounded-2xl border-2 flex flex-col lg:flex-row lg:justify-around justify-start items-center lg:items-start py-16">
                ...
                <div className="flex flex-col mt-3 lg:mt-0 lg:mr-4">
