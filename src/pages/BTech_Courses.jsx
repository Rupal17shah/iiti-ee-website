                ...
                <div className='justify-start -ml-16'>
                    ...
                    <table className='border-2 ml-32'>
                        <tr className='border-2 px-2 py-2'>
                            <th className='border-2 text-center px-2 py-2 capitalize w-48 bg-blue-200'>Course Code</th>
                            <th className='border-2 text-center w-96 bg-blue-200'>Course Name</th>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 104</td>
                            <td className='border-2 px-2 py-2 capitalize'>Basic Electrical and Electronics Engineering</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 154</td>
                            <td className='border-2 px-2 py-2 capitalize'>Basic Electrical and Electronics Engineering Lab</td>
                        </tr>
                    </table>
                    ...
                    <table className='border-2 ml-32'>
                        ...
                        <tr>
                            ...
                            <td className='border-2 px-2 py-2 capitalize'>Electronic Devices</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 205</td>
                            <td className='border-2 px-2 py-2 capitalize'>Introduction to Electrical Systems</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 253</td>
                            <td className='border-2 px-2 py-2 capitalize'>electronics devices lab</td>
                        </tr>
                    </table>
                    ...
                    <table className='border-2 ml-32'>
                        ...
                        <tr>
                            ...
                            <td className='border-2 px-2 py-2 capitalize'>Signals and systems</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className='border-2 px-2 py-2 capitalize'>Electrical machines and power electronics</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className='border-2 px-2 py-2 capitalize'>analog circuits lab</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 256</td>
                            <td className='border-2 px-2 py-2 capitalize'>Electrical machines lab</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 258</td>
                            <td className='border-2 px-2 py-2 capitalize'>digital Systems lab</td>
                        </tr>
                    </table>
                    ...
                    <table className='border-2 ml-32'>
                        ...
                        <tr>
                            ...
                            <td className='border-2 px-2 py-2 capitalize'>Microprocessors and digital systems design</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 303</td>
                            <td className='border-2 px-2 py-2 capitalize'>Probability and random processes</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 305</td>
                            <td className='border-2 px-2 py-2 capitalize'>electromagnetic waves</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 307</td>
                            <td className='border-2 px-2 py-2 capitalize'>Communication systems</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 309</td>
                            <td className='border-2 px-2 py-2 capitalize'>Electrical measurements and instrumentation</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 311</td>
                            <td className='border-2 px-2 py-2 capitalize'>VLSI systems and technology</td>
                        </tr>
                        <tr>
                            <td className='border-2 px-2 py-2'>EE 351N</td>
                            <td className='border-2 px-2 py-2 capitalize'>Microprocessors and digital systems design lab</td>
                        </tr>
                    </table>
